...
- [SpringBoot Docker Kubernetes](#springboot-docker-kubernetes)
  ...
  - [Sample App](#sample-app)
    - [Code](#code)
      - [1. `Customer.java` (Entity Class)](#1-customerjava-entity-class)
      - [2. `CustomerRepository.java` (Repository Interface)](#2-customerrepositoryjava-repository-interface)
      - [3. `CustomerDto.java` (DTO Class)](#3-customerdtojava-dto-class)
      - [4. `CustomerMapper.java` (Mapper Class)](#4-customermapperjava-mapper-class)
      - [5. `IService.java` (Service Interface)](#5-iservicejava-service-interface)
      - [6. `CustomerServiceImpl.java` (Service Implementation)](#6-customerserviceimpljava-service-implementation)
      - [7. `CustomerController.java` (Controller Class)](#7-customercontrollerjava-controller-class)
      - [8. `ResponseDto.java` (Custom Response Class)](#8-responsedtojava-custom-response-class)
      - [9. `ErrorResponseDto.java` (Error Response DTO)](#9-errorresponsedtojava-error-response-dto)
      - [10. `GlobalExceptionHandler.java` (Global Exception Handler)](#10-globalexceptionhandlerjava-global-exception-handler)
      - [11. `ResourceNotFoundException.java` (Custom Exception)](#11-resourcenotfoundexceptionjava-custom-exception)
      - [12. `Application.java` (Main Application Class)](#12-applicationjava-main-application-class)
